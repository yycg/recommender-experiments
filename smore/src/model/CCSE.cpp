...
void CCSE::LoadEdgeList(string filename, bool undirect) {
    pnet.LoadEdgeList(filename, undirect);
}

void CCSE::LoadFieldMeta(string filename) {
    pnet.LoadFieldMeta(filename);
}

void CCSE::SaveWeights(string model_name){
