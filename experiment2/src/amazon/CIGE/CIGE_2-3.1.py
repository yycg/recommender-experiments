...
def output_embeddings(user_embeddings, item_embeddings, attr_embeddings):
    with open("../../../data/amazon/embedding/IGE_user5.embed", "w") as file:
    ...
    with open("../../../data/amazon/embedding/IGE_item5.embed", "w") as file:
    ...
    with open("../../../data/amazon/embedding/IGE_attr5.embed", "w") as file:
