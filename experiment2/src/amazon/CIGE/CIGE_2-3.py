...
class CIGE:
    ...
    def create_model(self, num_users, num_items, embedding_size, num_attributes):
        ...
        dots_user_item = Lambda(lambda x: tf.reduce_sum(
            ...
            [user_vertex_latent, item_context_latent])  # shape=(?,)
        ...
        dots_user_user = Lambda(lambda x: tf.reduce_sum(
            ...
            [user_vertex_latent, user_context_latent])  # shape=(?,)
...
def output_embeddings(user_embeddings, item_embeddings, attr_embeddings):
    with open("../../../data/amazon/embedding/IGE_user6.embed", "w") as file:
    ...
    with open("../../../data/amazon/embedding/IGE_item6.embed", "w") as file:
    ...
    with open("../../../data/amazon/embedding/IGE_attr6.embed", "w") as file:
